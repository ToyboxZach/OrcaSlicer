...
#endif
//THIS HAS BEEN MOVED TO HeadlessGui.cpp to avoid including wx in the Plater class which is used by both GUI and headless modes. Any conflicts in this area
