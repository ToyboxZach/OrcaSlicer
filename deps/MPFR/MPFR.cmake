...
if (MSVC)
    ...
    if (EMSCRIPTEN)
        ...
        ExternalProject_Add(dep_MPFR
            ...
            BUILD_IN_SOURCE ON
            CONFIGURE_COMMAND autoreconf -f -i && 
                              env "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" CC_FOR_BUILD=gcc ./configure ${_cross_compile_arg}  --prefix=${DESTDIR} --enable-shared=no --enable-static=yes --with-gmp=${DESTDIR} --enable-assert=none --disable-thread-safe --disable-float128 --disable-decimal-float --enable-gmp-internals  --enable-static=yes
            BUILD_COMMAND touch aclocal.m4 configure Makefile.am Makefile.in ./doc/Makefile.am ./doc/Makefile.in ./doc/mpfr.info && make -j
            INSTALL_COMMAND make install
            DEPENDS dep_GMP
        )
    endif()
